...
elec$Time <- hms(elec$Time) # converting to class time
...
hist(elec$Global_active_power, col = "red", xlab  = "Globalive Power(kilowatts)", ylab = "Frequency", main = "Global Active Power")
dev.off()
